...
def ejecutar_sistema():
    ...
    entidades_maestras = [
        "S.A. HOSPITAL JOSE MARIA BENITEZ", "D.M.S. ZAMORA",
        "HOSPITAL NUESTRA SEÑORA DE LA CARIDAD", "D.M.S. GIRARDOT",
        "HOSPITAL JOSE RANGEL", "D.M.S. SUCRE",
        "HOSPITAL JOSE MARIA VARGAS", "S.A. HOSPITAL CENTRAL DE MARACAY",
        "CORPORACION DE SALUD DEL ESTADO ARAGUA", "D.M.S. REVENGA",
        "AMBULATORIO DE TURMERO",
        "HOSPITAL DEL SUR",
        "SOCIEDAD CIVIL HOSPITAL DEL SUR", "D.M.S. SAN CASIMIRO",
        "S.A.A.N.A.", "SALA DE PARTO DE TURMERO", "S.A.G.E.R.",
        "D.M.S. CAMATAGUA", "AMB. DE TURMERO", "SAANA", "SAGER",
        "D.M.S. LIBERTADOR", "D.M.S. SANTOS MICHELENA", "D.M.S. TOVAR",
        "HOSPITAL LAS TEJERIAS", "D.M.S. MARIÑO",
        "D.M.S. MARIO BRICEÑO IRAGORRI", "AMB. PALO NEGRO", "D.M.S. BOLIVAR",
        "D.M.S. FRANCISCO LINARES ALCANTARA", "AMB. LA CANDELARIA",
        "CLINICA PSIQUIATRICA DE MARACAY", "D.M.S. RIBAS",
        "SERVICIOS CENTRALES",
        "D.M.S. CAMATAGUA-URDANETA"

    ]
    
    entidades_detectadas = set()
    dfs_nom = extraer_datos_de_carpeta(dir_nom, entidades_maestras, entidades_detectadas, False)
    dfs_deu = extraer_datos_de_carpeta(dir_deu, entidades_maestras, entidades_detectadas, True)

    faltantes = [e for e in entidades_maestras if e not in entidades_detectadas]
    if faltantes:
