...
def main():
    ...
    if datos:
        reporte = ReporteExcel("Auditoria_Deducciones_Generado.xlsx")
        if reporte.generar_reporte(datos):
            messagebox.showinfo("Proceso Exitoso", "Se ha generado el archivo Excel con el Cuadre y la Base de Datos.")
    else:
